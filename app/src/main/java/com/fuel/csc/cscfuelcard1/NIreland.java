...
public class NIreland extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (flag==0) {
            ...
            final ProgressDialog progressDialog = new ProgressDialog(NIreland.this, android.R.style.Theme_DeviceDefault_Light_Dialog);
                    ...
                    try{
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                               ...
                               // Toast.makeText(NIreland.this,"No Signal",Toast.LENGTH_LONG).show();
                            }
                        });
            ...
            query.whereEqualTo("Country","N IRELAND");
            ...
            query.findInBackground(new FindCallback<ParseObject>() {
                ...
                public void done(List<ParseObject> objects, ParseException e) {
                    if (e == null) {
                        ...
                        ArrayAdapter<SiteDetail> adapter=new ArrayAdapter<SiteDetail>(NIreland.this,R.layout.activity_nireland ,sites){
                        ...
                        grid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                Intent i=new Intent(NIreland.this, NIreandActivity.class);
                                startActivityForResult(i, 1);

                            }
                        });
                        adapter1 = new ListViewAdapter(NIreland.this, sites);
                        // Capture Text in EditText
                        editsearch1 = (EditText) findViewById(R.id.search1);
                        grid.setAdapter(adapter);
                        editsearch1.addTextChangedListener(new TextWatcher() {
                            ...
                            public void afterTextChanged(Editable arg0) {
                                ...
                                String text = editsearch1.getText().toString().toLowerCase(Locale.getDefault());
                                Toast.makeText(NIreland.this, text, Toast.LENGTH_LONG).show();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_nireland, menu);
        return true;
    }
