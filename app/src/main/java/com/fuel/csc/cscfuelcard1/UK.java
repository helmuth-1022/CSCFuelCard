...
public class UK extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (flag==0) {
            ...
            final ProgressDialog progressDialog = new ProgressDialog(UK.this, android.R.style.Theme_DeviceDefault_Light_Dialog);
                    ...
                    try{
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                //Toast.makeText(UK.this,"No Signal",Toast.LENGTH_LONG).show();
                            }
                        });
            ...
            query.findInBackground(new FindCallback<ParseObject>() {
                ...
                public void done(List<ParseObject> objects, ParseException e) {
                    if (e == null) {
                        ...
                        //Toast.makeText(UK.this,"sss",Toast.LENGTH_LONG).show();
                        ...
                        ArrayAdapter<SiteDetail> adapter=new ArrayAdapter<SiteDetail>(UK.this,R.layout.activity_uk ,sites){
                        ...
                        grid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                Intent i=new Intent(UK.this, UKActivity.class);
                                startActivityForResult(i, 1);

                            }
                        });
                        adapter1 = new ListViewAdapter(UK.this, sites);
                        ...
                        //Toast.makeText(UK.this,"ddd",Toast.LENGTH_LONG).show();
                    }
                }
            });
            ...
            grid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Intent i=new Intent(UK.this, IrelandActivity.class);
                    startActivityForResult(i, 1);
